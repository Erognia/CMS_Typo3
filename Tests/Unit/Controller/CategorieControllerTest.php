...
/**
 * Test case for class Mris\MrisCatalogue\Controller\CategorieController.
 *
...
class CategorieControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Mris\MrisCatalogue\Controller\CategorieController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Mris\\MrisCatalogue\\Controller\\CategorieController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllCategoriesFromRepositoryAndAssignsThemToView()
	{
		...
		$categorieRepository = $this->getMock('Mris\\MrisCatalogue\\Domain\\Repository\\CategorieRepository', array('findAll'), array(), '', FALSE);
