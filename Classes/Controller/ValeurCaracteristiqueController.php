...
class ValeurCaracteristiqueController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    /**
     * valeurCaracteristiqueRepository
     *
     * @var \Mris\MrisCatalogue\Domain\Repository\ValeurCaracteristiqueRepository
     * @inject
     */
    protected $valeurCaracteristiqueRepository = NULL;
     ...
     * action show
     *
     * @param \Mris\MrisCatalogue\Domain\Model\ValeurCaracteristique $valeurCaracteristique
     * @return void
     */
    public function showAction(\Mris\MrisCatalogue\Domain\Model\ValeurCaracteristique $valeurCaracteristique)
    {
