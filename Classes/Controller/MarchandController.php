...
class MarchandController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * marchandRepository
     *
     * @var \Mris\MrisCatalogue\Domain\Repository\MarchandRepository
     * @inject
     */
     ...
     * action show
     *
     * @param \Mris\MrisCatalogue\Domain\Model\Marchand $marchand
     * @return void
     */
    public function showAction(\Mris\MrisCatalogue\Domain\Model\Marchand $marchand)
    {
